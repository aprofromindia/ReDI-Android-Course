...
public class RetainFragment extends Fragment {
    ...
    public void createPlace(final Consumer<Venue> consumer) {
        getConsumer = consumer;
        Call<Void> call = service.createVenue((Venue) getConsumer);
        call.enqueue(new Callback<Void>(){

            @Override
            public void onResponse(Call<Void> call, Response<Void> response) {
                Toast.makeText(getActivity(), "Venue successful created.", Toast.LENGTH_SHORT).show();
            }
